...
(function () {
  ...
  const FLAVORS = [
    {
      id: 'maracuya', img: KP_ASSETS + 'flavor-maracuya.jpg',
    ...
    {
      id: 'cereza', img: KP_ASSETS + 'flavor-cereza.jpg',
    ...
    {
      id: 'manzana', img: KP_ASSETS + 'flavor-manzana.jpg',
    ...
    {
      id: 'frambuesa', img: KP_ASSETS + 'flavor-frambuesa.jpg',
    ...
    {
      id: 'arandano', img: KP_ASSETS + 'flavor-arandano.jpg',
    ...
    {
      id: 'fresa', img: KP_ASSETS + 'flavor-fresa.jpg',
    ...
    {
      id: 'mango', img: KP_ASSETS + 'flavor-mango.jpg',
  ...
  const I18N = {
    es: {
      ...
      recipes: {
        ...
        list: [
          { name: 'Bubble Tea Clásico Frutal', cat: 'drink', img: KP_ASSETS + 'rec-bubble-tea.jpg',
          ...
          { name: 'Limonada Explosiva', cat: 'drink', img: KP_ASSETS + 'rec-limonada.jpg',
          ...
          { name: 'Smoothie Tropical Premium', cat: 'drink', img: KP_ASSETS + 'rec-smoothie.jpg',
          ...
          { name: 'Granizado King Pearl', cat: 'drink', img: KP_ASSETS + 'rec-granizado.jpg',
          ...
          { name: 'Mojito Explosivo', cat: 'cocktail', img: KP_ASSETS + 'rec-mojito.jpg',
          ...
          { name: 'Yogurt con Perlas', cat: 'dessert', img: KP_ASSETS + 'rec-yogurt.jpg',
          ...
          { name: 'Waffle Premium', cat: 'dessert', img: KP_ASSETS + 'rec-waffle.jpg',
          ...
          { name: 'Cheesecake Decorativo', cat: 'dessert', img: KP_ASSETS + 'rec-cheesecake.jpg',
          ...
          { name: 'Frappé Explosivo', cat: 'drink', img: KP_ASSETS + 'rec-frappe.jpg',
    ...
    en: {
      ...
      recipes: {
        ...
        list: [
          { name: 'Classic Fruit Bubble Tea', cat: 'drink', img: KP_ASSETS + 'rec-bubble-tea.jpg',
          ...
          { name: 'Bursting Lemonade', cat: 'drink', img: KP_ASSETS + 'rec-limonada.jpg',
          ...
          { name: 'Tropical Premium Smoothie', cat: 'drink', img: KP_ASSETS + 'rec-smoothie.jpg',
          ...
          { name: 'King Pearl Slushie', cat: 'drink', img: KP_ASSETS + 'rec-granizado.jpg',
          ...
          { name: 'Bursting Mojito', cat: 'cocktail', img: KP_ASSETS + 'rec-mojito.jpg',
          ...
          { name: 'Yogurt with Pearls', cat: 'dessert', img: KP_ASSETS + 'rec-yogurt.jpg',
          ...
          { name: 'Premium Waffle', cat: 'dessert', img: KP_ASSETS + 'rec-waffle.jpg',
          ...
          { name: 'Decorated Cheesecake', cat: 'dessert', img: KP_ASSETS + 'rec-cheesecake.jpg',
          ...
          { name: 'Bursting Frappé', cat: 'drink', img: KP_ASSETS + 'rec-frappe.jpg',

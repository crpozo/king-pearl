...
(function () {
  ...
  // injected by functions.php before data.js loads.
  ...
  function nav(t) {
    ...
    <header class="nv" id="nav">
      <div class="wrap nv__inner">
        ...
        <a href="#/" class="nv__brand"><img src="${KP_ASSETS}kp-logo.png" alt="King Pearl" /></a>
        <div class="nv__right">
          <div class="lang">
  ...
  function hero(t) {
    ...
    <section class="hero" id="top">
      ...
      <a class="hero__dot" href="#sabores" aria-label="scroll">
        <img src="${KP_ASSETS}crown-black.png" alt="" />
      </a>
    </section>`;
  }
    ...
    <section class="wa2" id="perlas">
      <div class="wrap">
        ...
        <div class="wa2__grid reveal d2">
          <figure class="wa2__img"><img src="${KP_ASSETS}hero-keyart.jpg" alt="${esc(c.title)}" loading="lazy" decoding="async" /></figure>
          <div class="wa2__acc">
  ...
  function about(t) {
    ...
    <section class="ab" id="nosotros">
      <div class="wrap ab__grid">
        ...
        <figure class="ab__art reveal d2"><img src="${KP_ASSETS}hero-keyart.jpg" alt="King Pearl" /></figure>
      </div>
    </section>`;
  }
      ...
      <div class="wrap ct__loc reveal">
        <div class="ct__card">
          <figure class="ct__photo">
            <img src="${KP_ASSETS}local-entrada.jpg" alt="Fachada de Autos Sierra — entrada a King Pearl" loading="lazy" />
    ...
    return `
      <footer class="ft">
        <div class="wrap ft__top">
          <div class="ft__brand">
            <img class="ft__logo" src="${KP_ASSETS}kp-logo.png" alt="King Pearl" />
  ...
  function preloadImages() {
    const urls = FLAVORS.map((f) => f.img).concat([KP_ASSETS + 'hero-keyart.jpg']);
